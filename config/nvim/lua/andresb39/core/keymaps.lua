...
--- new config ---
keymap.set("n", "<leader>p", ":NvimTreeToggle<CR>", { desc = "Toggle file explorer" }) -- toggle file explorer
keymap.set("n", "<leader>tv", ":botright vnew <Bar> :terminal<CR>")
keymap.set("n", "<leader>th", ":botright new <Bar> :terminal<CR>")
keymap.set("n", "<leader>w", ":w<CR>", { desc = "Save file" })
keymap.set("n", "<leader>f", ":Files<CR>", { desc = "Find files" })
--keymap.set("n", "<leader>f", ":Telescope find_files<cr>")
keymap.set("n", "<leader>s", ":Telescope live_grep<cr>")
